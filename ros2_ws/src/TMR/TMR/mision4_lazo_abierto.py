...
TARGET_ALTITUDE  = 1.5       # altura objetivo medida por sensor [m]
TARGET_Z         = -1.5       # en NED (negativo = arriba)
HOLD_DURATION    = 3.0        # espera tras despegue [s]

MOVE_SPEED       = 0.2        # velocidad de desplazamiento [m/s]
MOVE_RIGHT_TIME  = 3.0        # ← CAMBIA ESTO para más/menos desplazamiento a la derecha [s]
MOVE_FWD_TIME    = 4.0        # ← CAMBIA ESTO para más/menos avance al frente [s]
