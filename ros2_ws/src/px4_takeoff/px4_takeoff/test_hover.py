...
class PX4FlowPrecision(Node):
    def __init__(self):
        ...
        # Usar TRANSIENT_LOCAL en el sub causa mismatch silencioso → datos nunca llegan
        sub_qos = QoSProfile(
            reliability=ReliabilityPolicy.BEST_EFFORT,
        ...
        # Altura medida por el sensor de distancia (fuente principal de altura)
        ...
        # Parámetros de vuelo
        self.target_altitude = 1.2   # Altura objetivo en metros (positivo, desde el suelo)
    ...
    def flow_cb(self, msg):
        # Guardar siempre la distancia actual para usarla en la lógica de vuelo
